...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2024, 10, 23, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 23, 9, 0),
    end: new Date(2024, 10, 23, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 10, 23, 10, 0),
    end: new Date(2024, 10, 23, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 10, 23, 11, 0),
    end: new Date(2024, 10, 23, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 10, 23, 13, 0),
    end: new Date(2024, 10, 23, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 10, 23, 14, 0),
    end: new Date(2024, 10, 23, 14, 45),
  },
];
